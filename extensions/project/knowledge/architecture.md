...
independent Git repositories. Extensions are autonomous, source-owned bundles
copied under `extensions/<namespace>/<name>`.

`@hairness/cli` is the only package and Kernel. It validates the Home, manages
Extensions, Targets and Integrations, projects assets, builds the prologue and
