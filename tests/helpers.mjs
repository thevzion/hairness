...
export async function temporaryWorkspace() {
  ...
  await writeFile(join(extension, 'capabilities/artifacts.json'), JSON.stringify({ schemaVersion: 2, protocolVersion: '0.2', id: 'fixture/artifacts', owner: 'fixture/artifacts', version: '0.2.0-alpha.0', summary: 'Fixture operations.', operations: [{ id: 'produce', class: 'derive', summary: 'Produce fixture data.', inputSchema: './schemas/produce-input.schema.json', results: [{ id: 'default', contract: { schema: 'ArtifactEnvelope', disposition: 'artifact', artifactOwner: 'fixture/artifacts', artifactType: 'gate-result' } }], defaultResult: 'default', sources: [], effects: [], routes: ['worker'], acceptsModifiers: [] }, { id: 'mutate', class: 'effect', summary: 'Mutate fixture data.', results: [{ id: 'default', contract: { schema: 'ChangeReceipt', disposition: 'effect' } }], defaultResult: 'default', sources: [], effects: ['filesystem:write'], routes: ['worker'], acceptsModifiers: [] }] }))
  await writeFile(join(extension, 'extension.json'), JSON.stringify({ schemaVersion: 2, protocolVersion: '0.2', id: 'fixture/artifacts', version: '0.2.0-alpha.0', summary: 'Fixture artifact extension.', category: 'ecosystem', tags: ['fixture'], maturity: 'experimental', readme: './README.md', module: './index.mjs', capabilities: ['./capabilities/artifacts.json'], dependencies: [], commands: [], providerCommands: [], artifactSchemas: [{ type: 'gate-result', schema: './schemas/gate-result.schema.json' }] }))
