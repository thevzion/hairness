...
test('methodology output stays scratch until normalized into a semantic artifact', async () => {
  ...
  const manifest = { schemaVersion: 2, protocolVersion: '0.2', id: 'fixture/method', version: '0.2.0-alpha.0', module: './index.mjs', commands: [], providerCommands: [], methodologyBindings: [binding] }
