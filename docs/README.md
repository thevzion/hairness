...
Start with the [README](../README.md) for the product and commands, then use the
[protocol specification](../SPEC.md) for normative behavior.
...
- [Methodology bindings](concepts/methodology-bindings.md)
...
- [Extension contract](extensions/README.md)
- [Generic extension catalogue](extensions/catalog.md)
- [Provider projections](adapters.md)
- [Maintaining Hairness](maintaining.md)
- [Releasing](releasing.md)
- [Known limitations](known-limitations.md)
- [0.2.0-alpha.0 release notes](releases/0.2.0-alpha.0.md)
- [Security model](security-model.md)
- [Compatibility](compatibility.md)

## Decisions

- [0001 — Source-owned protocol](decisions/0001-source-owned-protocol.md)
- [0002 — Non-invasive integration, explicit operation](decisions/0002-non-invasive-explicit-operation.md)
- [0003 — Open-code distributions](decisions/0003-open-code-distributions.md)
