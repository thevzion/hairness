---
name: hairness-constraint-no-external
description: Forbid external effects in the active scope.
---

# hairness-constraint-no-external

Invocation: `$hairness-constraint-no-external`
Deterministic route: `hairness constraint set no-external --json`
