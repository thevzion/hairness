...
for (const required of ['bin/hairness.mjs', 'schemas/v4/home.schema.json', 'schemas/v4/asset.schema.json', 'assets/onboarding/hairness.json', 'assets/scratch/hairness.json']) assert.ok(paths.includes(required), `${required} missing from tarball`)
