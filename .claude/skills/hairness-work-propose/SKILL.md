---
name: hairness-work-propose
description: Produce one recommended direction inside the active frame.
---

# hairness-work-propose

Invocation: `/hairness-work-propose`
Deterministic route: `hairness work propose --json`
