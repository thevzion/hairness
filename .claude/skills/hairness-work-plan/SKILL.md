---
name: hairness-work-plan
description: Produce a typed work plan from accepted segment decisions.
---

# hairness-work-plan

Invocation: `/hairness-work-plan`
Deterministic route: `hairness work plan --json`
